...
export class VideoGalleryComponent {
  ...
  constructor(private sanitizer: DomSanitizer) {
    const links = [
      ...
      'https://www.youtube.com/watch?v=PO8Tx4TFeeE',
      ...
      'https://www.youtube.com/watch?v=Bv8kBz_GAxk',
      'https://www.youtube.com/watch?v=TlqtrzkrOlg',
      'https://www.youtube.com/watch?v=KdAH6hRfB8Y',
      'https://www.youtube.com/watch?v=QOf8v5s47G4',
      'https://www.youtube.com/watch?v=3pJJ8E-0vh4',
      'https://www.youtube.com/watch?v=bsWg7RwBp4I',
      'https://www.youtube.com/watch?v=ZhnbKJmLauc',
      'https://www.youtube.com/watch?v=ymqLjxPQYBU',
